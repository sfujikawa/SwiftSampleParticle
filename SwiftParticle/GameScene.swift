...
class GameScene: SKScene {
    ...
    override func didMoveToView(view: SKView) {
        ...
        // 光のパーティクルの発生装置
        let particleEmitter:SKEmitterNode = SKEmitterNode(fileNamed: "MyParticle.sks")!;
        particleNum = particleEmitter.particleBirthRate;
        // 煙のパーティクルの発生装置
        let smokeEmitter:SKEmitterNode = SKEmitterNode(fileNamed: "MySmoke.sks")!;
    ...
    */
    override func touchesBegan(touches: Set<UITouch>, withEvent event: UIEvent?) {
        ...
        let touchedCount:Int = touches.count;
    ...
    */
    override func touchesEnded(touches: Set<UITouch>, withEvent event: UIEvent?) {
        let touchEndCount:Int = touches.count;
    ...
    */
    func changeEmmitPointHandler(touches: Set<NSObject>) {
        for touch:NSObject in touches {
            let uiTouch:UITouch = touch as! UITouch;
            let location = uiTouch.locationInNode(self);
            emmitPoint = location;
        }
    }
